    ...
    const compareTableEntries = ([keyA, valueA], [keyB, valueB]) => {
        switch (sortByOption) {
            ...
            case sortByOptions[1]:
                return (
                    (new Date(valueA.createdAt) - new Date(valueB.createdAt)) *
                    (sortReversed ? -1 : 1)
                );
            case sortByOptions[2]:
                return (
                    (new Date(valueA.updatedAt) - new Date(valueB.updatedAt)) *
                    (sortReversed ? -1 : 1)
                );
                        ...
                        {pages != null &&
                            Object.entries(pages)
                                ...
                                .map(([name, details], index, filtered) => (
                                    <Fragment key={name}>
                                        <div
                                            className={`flex py-2 pl-4 pr-2 border-ui-border border border-t-0 items-center select-none ${
                                        ...
                                        >
                                            <span className="inline-flex items-center gap-1">
                                                {
                                                    deploymentStates[
                                                        details.deploymentStatus?.toLowerCase()
                                                        ]
                                                }
