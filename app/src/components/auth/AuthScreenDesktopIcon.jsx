function AuthScreenDesktopIcon() {
    return <svg width="759" height="543" viewBox="0 0 759 543" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path
            ...
            stroke="#666BE2" strokeWidth="2"/>
        <line x1="668.616" y1="101.716" x2="661.362" y2="477.716" stroke="#666BE2" strokeWidth="3"/>
        <line y1="-1.5" x2="376.07" y2="-1.5"
              transform="matrix(0.019289 0.999814 0.999814 -0.019289 693.714 101.687)" stroke="#666BE2"
              strokeWidth="3"/>
        <line x1="699" y1="457" x2="663" y2="457" stroke="#666BE2" strokeWidth="2"/>
        <line x1="699" y1="431" x2="663" y2="431" stroke="#666BE2" strokeWidth="2"/>
        <line x1="699" y1="405" x2="663" y2="405" stroke="#666BE2" strokeWidth="2"/>
        <line x1="699" y1="379" x2="663" y2="379" stroke="#666BE2" strokeWidth="2"/>
        <line x1="699" y1="354" x2="663" y2="354" stroke="#666BE2" strokeWidth="2"/>
        <line x1="697" y1="331" x2="665" y2="331" stroke="#666BE2" strokeWidth="2"/>
        <line x1="697" y1="302" x2="665" y2="302" stroke="#666BE2" strokeWidth="2"/>
        <line x1="695" y1="279" x2="665" y2="279" stroke="#666BE2" strokeWidth="2"/>
        <line x1="696" y1="254" x2="666" y2="254" stroke="#666BE2" strokeWidth="2"/>
        <line x1="694" y1="226" x2="668" y2="226" stroke="#666BE2" strokeWidth="2"/>
        <line x1="694" y1="202" x2="668" y2="202" stroke="#666BE2" strokeWidth="2"/>
        <line x1="694" y1="178" x2="668" y2="178" stroke="#666BE2" strokeWidth="2"/>
        <line x1="694" y1="151" x2="668" y2="151" stroke="#666BE2" strokeWidth="2"/>
        <line x1="694" y1="126" x2="668" y2="126" stroke="#666BE2" strokeWidth="2"/>
        ...
        <line x1="690.378" y1="0.107669" x2="691.587" y2="77.4839" stroke="#666BE2" strokeWidth="3"/>
        <line x1="671.033" y1="1.38768" x2="668.615" y2="77.5549" stroke="#666BE2" strokeWidth="3"/>
        <rect x="3.5" y="116.5" width="575" height="292" rx="13.5" stroke="#666BE2" strokeWidth="7"/>
        <path
            d="M565 426.5C572.456 426.5 578.5 420.456 578.5 413V401.5H3.5V413C3.5 420.456 9.54416 426.5 17 426.5H565Z"
            fill="#666BE2" stroke="#666BE2" strokeWidth="7"/>
        ...
        <rect x="76" y="273" width="434" height="82" rx="9" fill="#C9CBFF" stroke="#666BE2"
              strokeWidth="2"/>
        <rect x="76" y="174" width="221" height="83" rx="9" fill="#E3F0FF" stroke="#666BE2"
              strokeWidth="2"/>
        <rect x="317" y="238" width="193" height="83" rx="9" fill="#EEE1FF" stroke="#666BE2"
              strokeWidth="2"/>
        <path d="M342 238L406.803 191.062M406.803 191.062L471 238M406.803 191.062V102" stroke="#666BE2"
              strokeWidth="2"/>
    </svg>;
}
