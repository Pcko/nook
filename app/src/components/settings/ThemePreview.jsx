function ThemePreview({theme, isSelected}) {
    ...
    return (
        <div className="scale-[0.9] origin-top-left">
            <div
                className={`${appliedClass} bg-far-bg ${isSelected ? 'border-primary' : 'border-ui-border'} border-[3px] rounded-[5px] p-3 pb-0 select-none`}>
                <div className="flex h-full border-ui-border border border-b-0">
                    ...
                    <div className="bg-ui-bg">
                        <div className="h-[30%] flex p-1">
                            <h1 className="my-auto text-xs text-text mr-2 hover:cursor-default whitespace-nowrap">
                                Your Dashboard
                            </h1>
