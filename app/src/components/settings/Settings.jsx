            ...
            <div className="ml-[5%] grid grid-cols-[20%_80%] gap-[2vw] text-text">
                <div className="w-full min-h-[100vh] py-[10vh]">
                    ...
                    <div
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5}
                             stroke="currentColor" className="h-7 mr-1 text-text-subtle">
                    ...
                    <div
                        className={`flex items-center w-full mb-5 p-2 cursor-pointer rounded ${activeTab === 'appearance' ? 'bg-ui-bg-selected' : 'bg-transparent'}`}
                    ...
                    <div
                        className={`flex items-center w-full p-2 cursor-pointer rounded ${activeTab === 'security' ? 'bg-ui-bg-selected' : 'bg-transparent'}`}
